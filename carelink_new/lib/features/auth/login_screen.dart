...
// TODO: REMOVE BEFORE FINAL SUBMISSION — debug seed import
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  bool _obscure = true;
  String? _error;
  // TODO: REMOVE BEFORE FINAL SUBMISSION — debug seed flag
  bool _seeding = false;
  ...
  // TODO: REMOVE BEFORE FINAL SUBMISSION — debug seed method
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('🎉 Seed complete! Firestore now has demo data.'),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    // ─────────────────────────────────────────────────────
                    // TODO: REMOVE BEFORE FINAL SUBMISSION — debug seed button
                    // ─────────────────────────────────────────────────────
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text(
                          _seeding ? 'Seeding Firestore...' : '🌱 Seed Demo Data',
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      '⚠️ Debug only — remove before submission',
